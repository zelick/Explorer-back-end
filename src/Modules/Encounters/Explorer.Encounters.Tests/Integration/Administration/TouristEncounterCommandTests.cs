...
namespace Explorer.Encounters.Tests.Integration.Administration
{
    ...
    public class TouristEncounterCommandTests : BaseEncountersIntegrationTest
    {
        public TouristEncounterCommandTests(EncountersTestFactory factory) : base(factory) { }
        ...
        private static TouristEncounterController CreateController(IServiceScope scope)
        {
