...
namespace Explorer.Tours.Tests.Integration.Tourism
{
    ...
    public class PrivateTourCommandTests: BaseToursIntegrationTest
    {
        ...
        [Fact]
        public void createPrivateTourBlog_Succeed()
        {
            using var scope = Factory.Services.CreateScope();
            var controller = CreateController(scope);
            var dbContext = scope.ServiceProvider.GetRequiredService<ToursContext>();
            PrivateTourDto privateTourDto = new PrivateTourDto()
            {
                ...
                Execution = null,
                Blog  = new PrivateTourBlogDto() { Title = "Blog title", Description="Blog desription", Equipment="Blog equipment"}
            };
            privateTourDto.Execution = null;
            privateTourDto.Blog = new PrivateTourBlogDto() { Title = "Blog title", Description = "Blog desription", Equipment = "Blog equipment" };
            // Act
            Exception ex = null;
            try
            {
                var result = ((ObjectResult)controller.CreateBlog(privateTourDto).Result)?.Value as PrivateTourDto;
            }
            catch (Exception e)
            {
                ex = e;
