...
public class LoginTests : BaseStakeholdersIntegrationTest
{
    ...
    {
        return new AuthenticationController(scope.ServiceProvider.GetRequiredService<IAuthenticationService>(), scope.ServiceProvider.GetRequiredService<IEmailService>(), scope.ServiceProvider.GetRequiredService<IVerificationService>());
    }
}